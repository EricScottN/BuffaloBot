...
class BufCommands(commands.Cog, name='Buffalo Commands'):
    ...
    @app_commands.describe(county="County you're registered to vote in")
    # @app_commands.guilds(discord.Object(id=guild_id))
    async def get_voting_info(self, interaction: discord.Interaction, county: counties = None):
        if county == 'Erie':
            await interaction.response.send_message(f"Visit the following link and enter your full name and "
                                                    f"date of birth to view your voter information and/or sample"
                                                    f"ballot, or to find your polling location\n\n"
                                                    f"**https://www.elections.erie.gov/VSearch2**\n\n"
                                                    f"You can also apply for an absentee ballot here: "
                                                    f"https://www.elections.erie.gov/AbsenteeApp")
